 ...
 */
public class Inicialization_CUAM_FB extends Application {
    @Override
    ...
    public void printKeyHash() {
        try {
            PackageInfo info = getPackageManager().getPackageInfo("com.naveli.mobauacm.comedoruacm", PackageManager.GET_SIGNATURES);
